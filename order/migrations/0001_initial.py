# Generated by Django 3.2 on 2021-08-06 13:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('open', 'Открытый'), ('in_progress', 'В процессе'), ('canceled', 'Отмененный'), ('finished', 'Завершенный')], max_length=20)),
            ],
            options={
                'db_table': 'orders',
            },
